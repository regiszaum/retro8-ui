...
const localized = {
  ...
  Iniciar missão
    ...
    componentPage: {
      ...
      dateTimePickerPlayground: {
        title: "Playground do DateTime Picker",
        copy: "Teste locale, inicio da semana, densidade dos horarios e limites do painel antes de copiar o markup final.",
        placeholderField: "Placeholder",
        localeField: "Locale",
        weekStartField: "Inicio da semana",
        timeStepField: "Intervalo de hora",
        statesLabel: "Estados rapidos",
        previewLabel: "Previa configuravel",
        previewCopy: "Este playground cobre o recorte mais seguro do DateTime Picker: contexto de locale, calendario + slots de hora e limites declarativos sem puxar fluxos maiores como range ou timezones gerenciados pela aplicacao.",
        eventsLabel: "Eventos ao vivo",
        markupLabel: "Markup atual",
        resetLabel: "Redefinir",
        constrainedLabel: "Com min/max",
        helperCopy: "Use passos menores quando a pessoa precisar escolher horarios precisos e preserve min/max para bloquear janelas fora da operacao.",
        eventIdle: "Aguardando interacao com o DateTime Picker.",
        clearedLabel: "data e hora limpas",
        defaultPlaceholder: "Select maintenance window",
        options: {
          ptBR: "Portugues (BR)",
          enUS: "English (US)",
          sunday: "Domingo",
      ...
      inputPlayground: {
        ...
        copy: "Teste o shell opcional do campo com texto, email, senha, textarea e number antes de copiar o markup final.",
        ...
        statesLabel: "Estados rapidos",
        previewLabel: "Previa configuravel",
        previewCopy: "Este playground cobre o recorte mais seguro da comparacao com o Element Plus: clear, contador de caracteres, toggle de senha, textarea com autosize e number com min/max/step, sem puxar APIs mais pesadas como formatter/parser ou estruturas prepend/append.",
        eventsLabel: "Eventos ao vivo",
        markupLabel: "Markup atual",
        resetLabel: "Redefinir",
        clearableLabel: "Com clear",
  ...
  Start mission
    ...
    componentPage: {
      ...
      dateTimePickerPlayground: {
        title: "DateTime Picker playground",
        copy: "Try locale, week-start, time-slot density, and panel bounds before copying the final markup.",
        placeholderField: "Placeholder",
        localeField: "Locale",
        weekStartField: "Week start",
        timeStepField: "Time step",
        statesLabel: "Quick states",
        previewLabel: "Configurable preview",
        previewCopy: "This playground covers the safest slice of the DateTime Picker: locale context, calendar + time slots, and declarative bounds without pulling in heavier flows like ranges or app-managed timezones.",
        eventsLabel: "Live events",
        markupLabel: "Current markup",
        resetLabel: "Reset",
        constrainedLabel: "Min/max",
        helperCopy: "Use smaller steps when people need precise times, and keep min/max when the schedule should stay inside an operational window.",
        eventIdle: "Waiting for DateTime Picker interaction.",
        clearedLabel: "date and time cleared",
        defaultPlaceholder: "Select maintenance window",
        options: {
          ptBR: "Portuguese (BR)",
          enUS: "English (US)",
      ...
      inputPlayground: {
        ...
        copy: "Try the optional field shell with text, email, password, textarea, and number before copying the final markup.",
        ...
        statesLabel: "Quick states",
        previewLabel: "Configurable preview",
        previewCopy: "This playground covers the safest slice of the Element Plus comparison: clear, character counting, password reveal, autosize textareas, and number fields with min/max/step without pulling in heavier formatter/parser APIs or structured prepend/append shells.",
        eventsLabel: "Live events",
        markupLabel: "Current markup",
        resetLabel: "Reset",
        clearableLabel: "Clearable",

...
const localized = {
  ...
  Iniciar missão
    ...
    componentPage: {
      ...
      formPlayground: {
        title: "Playground do Form",
        copy: "Monte um formulario com email, senha, select, rate, radio e checkbox para validar estrutura e interacao antes de copiar o markup final.",
        emailField: "Email",
        passwordField: "Senha",
        roleField: "Papel",
        channelField: "Canal",
        ...
        statesLabel: "Estados rapidos",
        previewLabel: "Previa configuravel",
        previewCopy: "Este playground une os controles mais usados do ecossistema form em um unico fluxo: campos de credencial, escolha unica, avaliacao, preferencias e acoes finais.",
        eventsLabel: "Eventos ao vivo",
        markupLabel: "Markup atual",
        resetLabel: "Redefinir",
        policyLabel: "Checkbox marcado",
        submitDisabledLabel: "Submit desabilitado",
        emailHelp: "Use um email monitorado para alertas de rota.",
        passwordHelp: "Mantenha uma senha curta e troque por missao.",
        roleHelp: "Define quem assume o fluxo principal.",
        rateHelp: "Pontue o nivel de confianca antes de salvar.",
        policyLegend: "Permissoes",
        policyText: "Permitir notificacoes agendadas",
        submitLabel: "Salvar",
        cancelLabel: "Cancelar",
        eventIdle: "Aguardando interacao com o Form.",
        emailEventLabel: "email",
        passwordEventLabel: "senha",
        roleEventLabel: "papel",
        rateEventLabel: "rate",
        channelEventLabel: "canal",
        checkboxEventLabel: "checkbox",
        submitEventText: "submit acionado",
        checkedState: "marcado",
        uncheckedState: "desmarcado",
        emptyValue: "vazio",
        passwordUpdated: "atualizada",
        defaultEmail: "pilot@retro8.dev",
        defaultPassword: "retro-88",
        options: {
          engineer: "Engineer",
          medic: "Medic",
          explorer: "Explorer",
  ...
  Start mission
    ...
    componentPage: {
      ...
      formPlayground: {
        ...
        copy: "Build a form with email, password, select, rate, radio, and checkbox so you can validate structure and interaction before copying the final markup.",
        emailField: "Email",
        ...
        statesLabel: "Quick states",
        previewLabel: "Configurable preview",
        previewCopy: "This playground combines the most common form controls in one flow: credential fields, single-choice inputs, rating, preferences, and final actions.",
        eventsLabel: "Live events",
        markupLabel: "Current markup",
        resetLabel: "Reset",
        policyLabel: "Checkbox checked",
        submitDisabledLabel: "Submit disabled",
        emailHelp: "Use a monitored inbox for route alerts.",
        passwordHelp: "Keep a short password and rotate it per mission.",
        roleHelp: "Defines who owns the main route flow.",
        rateHelp: "Score confidence quickly before saving.",
        policyLegend: "Permissions",
        policyText: "Allow scheduled notifications",
        submitLabel: "Save",
        cancelLabel: "Cancel",
        eventIdle: "Waiting for Form interaction.",
        emailEventLabel: "email",
        passwordEventLabel: "password",
        roleEventLabel: "role",
        rateEventLabel: "rate",
        channelEventLabel: "channel",
        checkboxEventLabel: "checkbox",
        submitEventText: "submit triggered",

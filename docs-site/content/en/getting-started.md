---
title: Quick start
description: Install the library, import the CSS and use `r8-*` classes with short, predictable HTML.
kicker: Guide
---
...
2. import `retro8.css`
3. write semantic HTML with classes like `r8-btn`, `r8-panel` and `r8-window`
